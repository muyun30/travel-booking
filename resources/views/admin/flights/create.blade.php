...
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-white mb-8">➕ Ajouter un vol</h1>
    ...
    <form method="POST" action="/admin/flights" class="bg-gray-900 border border-gray-800 rounded-2xl p-8 space-y-5">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="text-gray-400 text-sm block mb-1">Compagnie</label>
                <input name="airline" required value="{{ old('airline') }}"
            ...
            <div>
                ...
                <input name="flight_number" required value="{{ old('flight_number') }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:outline-none">
            </div>
            <div>
                <label class="text-gray-400 text-sm block mb-1">Origine</label>
                <input name="origin" required value="{{ old('origin') }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:outline-none">
            </div>
            <div>
                <label class="text-gray-400 text-sm block mb-1">Destination</label>
                <input name="destination" required value="{{ old('destination') }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:outline-none">
            </div>
            <div>
            ...
            <div>
                ...
                <input name="price" type="number" step="0.01" required value="{{ old('price') }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:outline-none">
            </div>
            <div>
                <label class="text-gray-400 text-sm block mb-1">Places disponibles</label>
                <input name="seats_available" type="number" required value="{{ old('seats_available') }}"
                    class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:border-purple-500 focus:outline-none">
            </div>
        </div>
